...
public class WorldFeatureHangingDungeon {
	...
	public static class Basalt extends WorldFeature {
		private final static WeightedRandomBag<Block<?>> hangingDungeonBase = new WeightedRandomBag<>();
		...
		@Override
		public boolean place(World world, Random random, int i, int i1, int i2) {
			return this.place(world, random, new TilePos(i, i1, i2));
		}
	}

	public static class Slate extends WorldFeature {
		private final static WeightedRandomBag<Block<?>> hangingDungeonBase = new WeightedRandomBag<>();

		static {
			hangingDungeonBase.addEntry(Blocks.BRICK_SLATE,  1  );
			hangingDungeonBase.addEntry(Blocks.SLATE_POLISHED, .75);
			hangingDungeonBase.addEntry(Blocks.BLOCK_ASH, .10);
		}
	...
	public static class Gloomstone extends WorldFeature {
		private final static WeightedRandomBag<Block<?>> hangingDungeonBase = new WeightedRandomBag<>();
	...
	public static class Netherrack extends WorldFeature {
		private final static WeightedRandomBag<Block<?>> hangingDungeonBase = new WeightedRandomBag<>();
